      ...
      <div className="max-w-4xl mx-auto px-6 py-12 space-y-16">
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-6">
            ...
            <div className="flex items-center gap-4 p-5 rounded-2xl border border-[#1E2035] bg-[#0D0E1A]">
              <div className="w-10 h-10 rounded-xl bg-[#4AFF9115] flex items-center justify-center text-[#4AFF91] flex-shrink-0">
              ...
              <div>
                ...
                <div className="text-gray-500 text-sm">github.com/adarshahalder/chadwallet</div>
              </div>
            </div>
          </div>
